...
const Register = () => {
    ...
    const validateStep = (currentStep) => {
        if (currentStep === 1) { // Personal
            if (!formData.firstName || !formData.lastName || !formData.email || !formData.phone || !formData.registrationId) {
                addToast("Please fill in all Personal details including Registration ID.", "error");
                return false;
            }
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            addToast('Registration complete. Our Admin will send your credentials. Thank you.', 'success');
    ...
    return (
        <div className="container" style={{
            ...
            <div className="card" style={{
                ...
                height: '95%', // Fit within the fixed container
                maxHeight: '900px',
                        ...
                        {step === 1 && (
                            <div className="step-content" style={{ animation: 'fadeIn 0.4s ease', maxWidth: '600px', margin: '0 auto' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
                                    ...
                                    <div className="form-group">
                                        <label style={labelStyle}>Registration Number / ID*</label>
                                        <input name="registrationId" value={formData.registrationId} onChange={handleChange} required placeholder="STU-2024-001" style={roundedInputStyle} />
                                    </div>
                                </div>
                                ...
                                <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                                    ...
                                    <label style={{
                                        ...
                                        <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.25rem' }}>
                                            {formData.idProofFile ? 'Click to change' : 'Supports JPG, PNG, PDF'}
                                        </div>
                                    </label>
                                </div>
