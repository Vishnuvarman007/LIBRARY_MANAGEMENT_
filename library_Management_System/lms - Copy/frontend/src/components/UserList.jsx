...
import PendingMemberships from './admin/PendingMemberships';

const UserList = () => {
    const [users, setUsers] = useState([]);
    const [filter, setFilter] = useState('PENDING'); // 'PENDING', 'APPROVED', or 'MEMBERSHIPS'
        ...
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <div>
                    ...
                    <button
                        className={`btn ${filter === 'MEMBERSHIPS' ? 'btn-primary' : 'btn-secondary'}`}
