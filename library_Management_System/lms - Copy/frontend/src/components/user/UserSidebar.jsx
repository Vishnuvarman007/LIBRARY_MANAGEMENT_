...
import { FaUserCircle, FaBook, FaHistory, FaCog, FaSignOutAlt, FaSearch, FaStar, FaHeart } from 'react-icons/fa';
...
const UserSidebar = () => {
    ...
    const navItems = [
        ...
        { path: '/user/favorites', icon: <FaHeart />, label: 'Favorites' },
        { path: '/user/membership', icon: <FaStar />, label: 'Membership' },
